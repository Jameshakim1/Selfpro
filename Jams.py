...
#--------------------------------------------------------------
		...
		if msg.from_ in Creator:
                    for i in gid:
                        h = jams.getGroup(i).name
		        if h == ng:
			    jams.sendText(i,"Combat Di Paksa Keluar Oleh Owner!")
		            jams.leaveGroup(i)
		...
		gid = jams.getGroupIdsJoined()
                if msg.from_ in Creator:
		    for i in gid:
			jams.sendText("Combat Di Paksa Keluar Oleh Owner!")
		        jams.leaveGroup(i)
		...
		if msg.from_ in admin:
                    ...
                    wait["detectMention2"] = False
                    wait["detectMention3"] = False                    
                    jams.sendText(msg.to,"Auto R Kick Sudah Aktif")
		else:
		    jams.sendText(msg.to,"Khusus Admin")
		...
		if msg.from_ in admin:
                    wait["kickMention"] = False                    
                    jams.sendText(msg.to,"Auto R Kick Sudah Off")
		else:
		    jams.sendText(msg.to,"Khusus Admin")			  
		...
		if msg.from_ in admin:
		    ...
		    jams.sendText(msg.to,"Khusus Admin")
                ...
                wait["Sider"] = True
                jams.sendText(msg.to,"Ngintip nih....!!!!!")
                ...
                if msg.to in cctv['point']:
                    ...
                    jams.sendText(msg.to, "Set Dulu Boss")                         
		...
		jams.sendText(msg.to,"Hadir Booooss....")
		...
		if msg.from_ in Creator:
		    jams.sendText(msg.to, "Reload Boss...")
		    restart_program()
		    print "@Restart"
		else:
		...
		if msg.from_ in Creator:
	         ...
	         random.choice(KAC).sendText(msg.to,"♐LOE SONGONG BERARTI LOE SIAP ANCUR🖕🖕")
                ...
                jams.sendText(msg.to,"BOT SIMISIMI TURN ON")
                ki.sendText(msg.to,"already turn active")
            elif msg.text in ["Simisimi off","Simisimi:off"]:
                settings["simiSimi"][msg.to] = False
                jams.sendText(msg.to,"BOT SIMISIMI TURN OFF")
	           ...
	           if msg.from_ in admin:
                ...
                jams.sendText(msg.to, msgs)
                    ...
                    jams.sendText(msg.to, "Di Add Ya")
